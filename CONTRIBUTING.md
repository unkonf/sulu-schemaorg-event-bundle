...
If you are working on new features or refactoring [create a proposal](https://github.com/unKonf/sulu-securitytxt-bundle/issues/new).
...
```console
$ git clone git@github.com:unKonf/sulu-schemaorg-event-bundle.git
$ cd sulu-schemaorg-event-bundle
```
...
2. Fork the repository (http://github.com/unKonf/sulu-schemaorg-event-bundle)
...
```console
$ git remote add {username} git@github.com:{username}/sulu-schemaorg-event-bundle.git
$ git fetch {username}
```

### Keeping Up-to-Date

Periodically, you should update your fork or personal repository to match the canonical sulu-schemaorg-event-bundle repository.
...
To ssh://git@github.com/{username}/sulu-schemaorg-event-bundle.git
